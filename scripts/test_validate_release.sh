...
assert_contract(
  ...
  "release artifacts must use the pinned Node.js 24 upload action"
)
assert_contract(
  remote_actions.count(download_action) == 4,
  "release artifacts must use the pinned Node.js 24 download action"
)
